#!/bin/bash
#SBATCH -t 66:00:00          # Runtime in D-HH:MM, minimum of 10 minutes
...
--explabel GPT2_small_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream16M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 400000 --n_class 0 --n_embd 384 --n_layer 12 --n_head 6 --batch_size 64  --total_steps 1000000
--explabel GPT2_small_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream1_6M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 40000 --n_class 0 --n_embd 384 --n_layer 12 --n_head 6 --batch_size 64  --total_steps 1000000
--explabel GPT2_small_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream0_016M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 400 --n_class 0 --n_embd 384 --n_layer 12 --n_head 6 --batch_size 64  --total_steps 1000000
--explabel GPT2_medium_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream16M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 400000 --n_class 0 --n_embd 768 --n_layer 24 --n_head 12 --batch_size 64  --total_steps 1000000
--explabel GPT2_medium_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream1_6M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 40000 --n_class 0 --n_embd 768 --n_layer 24 --n_head 12 --batch_size 64  --total_steps 1000000
--explabel GPT2_medium_joint_lm_sep_emb_RAVEN_uncond_heldout0_stream0_016M --heldout_ids 1 16 20 34 37 --embed_type sep   --cmb_per_class 400 --n_class 0 --n_embd 768 --n_layer 24 --n_head 12 --batch_size 64  --total_steps 1000000
'
