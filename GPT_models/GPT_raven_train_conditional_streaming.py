...
attr_seq_tsr_train, attr_seq_tsr_val, attr_seq_tsr_val_eval = \
    attr_seq_tsr[train_mask, :-500], attr_seq_tsr[:, -500:], attr_seq_tsr[:, -50:] # changed June 30, 2024, also eval on untrained rules.
y_rule_train, y_rule_val, y_rule_val_eval = y_rule[train_mask, :-500], y_rule[:, -500:], y_rule[:, -50:]
