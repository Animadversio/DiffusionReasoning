...
attr_img_tsr_train, attr_img_tsr_val = attr_img_tsr[train_mask, :3950], attr_img_tsr[train_mask, 3950:]
...
explabel = "GPT2_big_RAVEN_uncond_heldout0"
...
for epoch in range(epoch_total):
    ...
    th.save({"eval_complete": eval_complete, "C3_list": C3_list, "C2_list": C2_list, "rule_col_list": rule_col_list}, 
